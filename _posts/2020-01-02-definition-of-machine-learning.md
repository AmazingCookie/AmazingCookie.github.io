...
**Cost Function**: Measure the accuracy of _h_ by taking an average difference of _hθ(x)_ and _y_. The purpose of the algorithm is to find parameters which minimize the cost function.
